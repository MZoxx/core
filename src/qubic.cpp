...
#if START_NETWORK_FROM_SCRATCH
    // QRACEL has no IPO on fresh testnet, so initializeContractErrors() incorrectly
    // marks it as IPO-failed. Clear the error and set fee reserve to allow it to run.
